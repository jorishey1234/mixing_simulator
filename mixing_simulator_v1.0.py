...
CANVAS_SIZE = (Np*p*4,Np*4)  # (width, height)
...
# 		layout.addWidget(self.pause_chooser)
		...
		self.fps_sl.setMinimum(0)
		self.fps_sl.setMaximum(600)
		self.fps_sl.setValue(250)
